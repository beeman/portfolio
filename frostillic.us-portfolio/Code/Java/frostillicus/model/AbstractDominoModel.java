...
public abstract class AbstractDominoModel implements Serializable, DataObject, ViewRowData {
	 ...
	 ************************************************************************/
	protected boolean querySave(final Document doc) { return true; }
	protected void postSave(final Document doc) { }

	protected abstract Collection<String> summaryFields();
	protected Collection<String> authorsFields() { return Arrays.asList(new String[] { }); }
	protected Collection<String> readersFields() { return Arrays.asList(new String[] { }); }
	protected Collection<String> namesFields() { return Arrays.asList(new String[] { }); }
	protected Collection<String> attachmentFields() { return Arrays.asList(new String[] { }); }


	public final boolean isNew() { return documentId_.isEmpty(); }
	public final boolean isCategory() { return category_; }
	public final int columnIndentLevel() { return columnIndentLevel_; }
	public final String viewRowPosition() { return viewRowPosition_; }
	...
	public void setValue(final Object keyObject, final Object value) {
		if(isCategory()) { throw new UnsupportedOperationException("Categories cannot be modified"); }
		if(!(keyObject instanceof String)) { throw new IllegalArgumentException(); }
		String key = ((String)keyObject).toLowerCase();
		...
		if(attachmentFields().contains(key)) {
			if(!(value instanceof UploadedFile)) { throw new IllegalArgumentException(key + " is an attachment field"); }
	...
	protected final Object getValueImmediate(final Object keyObject) {
		...
		if(!values_.containsKey(key)) {
			try {
				...
				List<Object> itemValue = doc.getItemValue(key);
	...
	private final Method findGetter(final String key) {
		...
		if(getterCache_ == null) getterCache_ = new HashMap<String, Method>();
	...
	private final List<Method> findSetters(final String key) {
		String lkey = key.toLowerCase();
		if(setterCache_ == null) setterCache_ = new HashMap<String, List<Method>>();
	 ...
	 * ViewRowData methods
	 ************************************************************************/
	public final Object getColumnValue(final String key) { return getValue(key); }
	public final void setColumnValue(final String key, final Object value) { setValue(key, value); }
	public final ViewRowData.ColumnInfo getColumnInfo(final String key) { return null; }
	...
	public final boolean isReadOnly(final String key) { return isReadOnly((Object)key); }
	public final Object getValue(final String key) { return getValue((Object)key); }


	/* **********************************************************************
	 * The dirty work of actually saving the document
	 ************************************************************************/
	@SuppressWarnings("unchecked")
	public boolean save() {
		if(isCategory()) { throw new UnsupportedOperationException("Categories cannot be saved"); }
