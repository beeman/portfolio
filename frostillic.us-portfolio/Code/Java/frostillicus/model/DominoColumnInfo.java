...
public class DominoColumnInfo implements Serializable {
	...
	public boolean isResortAscending() { return resortAscending_; }
	public boolean isResortDescending() { return resortDescending_; }
	public boolean isCategory() { return category_; }
}
